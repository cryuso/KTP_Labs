...
public class BurningShip extends FractalGenerator {
	...
	/**
	* Если значение Z в рекуррентной формуле Z(n+1)=Z(n)^2 + c; стремится к бесконечности - 
	...
	* При представлении формулы множества BurningShip как итеративной последовательности значений координат на плоскости,
	...
	**/
	...
	public int numIterations(double x, double y) {
		...
		// -1 - точка принадлежит последовательности, iteration - не принадлежит. Также определяем, насколько она близко
